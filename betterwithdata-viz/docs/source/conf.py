...
# -*- coding: utf-8 -*-
#
# betterwithdata_viz documentation build configuration file
#
...
_version_py = os.path.join(repo, 'betterwithdata_viz', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'betterwithdata_vizdoc'
...
latex_documents = [
    (master_doc, 'betterwithdata_viz.tex', 'betterwithdata_viz Documentation',
...
man_pages = [
    (master_doc,
    'betterwithdata_viz',
    'betterwithdata_viz Documentation',
     [author], 1)
]
